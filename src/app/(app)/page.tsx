...
export default function HomePage() {
  ...
  <header className="sticky top-0 z-20 border-b border-white/5 bg-[#180819]/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 md:px-6">
          ...
          <div className="flex items-center gap-3 text-xs">
            <Link className="hidden rounded-full bg-[#30112f] px-5 py-2 font-semibold text-white hover:bg-[#3a1839] md:inline-block" href="/sign-in">
              Login
            </Link>

            <Link className="rounded-full bg-pink-500 px-5 py-2 font-semibold text-white shadow-[0_0_20px_rgba(255,0,122,0.6)] hover:bg-pink-600" href="/sign-up">
              Sign Up
            </Link>
          </div>
        </div>
  ...
  <div className="relative flex w-full justify-center md:w-auto">
    ...
    {/* Images */}
    <div className="mt-8 flex w-full max-w-90 items-center justify-center gap-3 md:max-w-105">
      {/* Before phone */}
...
<section className="mt-14 grid gap-6 md:grid-cols-3">
  {/* Followers Delivered */}
  <div className="flex flex-col items-center justify-center rounded-[30px] bg-[#1a0d24] px-10 py-10 text-center">
  ...
  <div className="mt-10 grid gap-6 md:grid-cols-4">
    ...
    <div className="rounded-[30px] bg-[#1a0d24] px-6 py-8 text-left">
      ...
      <p className="mt-3 text-[11px] leading-relaxed text-white/60">
        Boost your TikTok visibility with
        real, active followers instantly.
      </p>
    </div>
    ...
    <div className="rounded-[30px] bg-[#1a0d24] px-6 py-8 text-left">
      ...
      <p className="mt-3 text-[11px] leading-relaxed text-white/60">
        Gain more subscribers and
        watch time for your YouTube
        channel.
      </p>
    </div>
    ...
    <div className="rounded-[30px] bg-[#1a0d24] px-6 py-8 text-left">
      ...
      <p className="mt-3 text-[11px] leading-relaxed text-white/60">
        Build a strong community on
        Facebook with genuine followers.
      </p>
    </div>
  </div>
</section>
...
<section className="mt-20">
  ...
  <p className="mt-3 text-center text-[11px] text-white/60 md:text-xs">
    Our coin economy ensures a fair exchange of engagement between real users.
  ...
  <div className="mt-10 grid gap-6 md:grid-cols-3">
    ...
    <div className="relative overflow-hidden rounded-[30px] bg-[#1a0d24] px-6 py-8 text-left">
      ...
      <p className="mt-3 text-[11px] leading-relaxed text-white/60">
        Connect your public TikTok username. We never ask for your password,
        keeping your account 100% secure.
      </p>
    </div>
    ...
    <div className="relative overflow-hidden rounded-[30px] bg-[#1a0d24] px-6 py-8 text-left">
      ...
      <p className="mt-3 text-[11px] leading-relaxed text-white/60">
        Earn coins instantly by following other real creators in the community.
        The more you follow, the more you earn.
      </p>
    </div>
    ...
    <div className="relative overflow-hidden rounded-[30px] bg-[#1a0d24] px-6 py-8 text-left">
      ...
      <p className="mt-3 text-[11px] leading-relaxed text-white/60">
        Spend your hard-earned coins to get real followers delivered to your
        profile and boost your engagement.
      </p>
    </div>
  </div>
</section>
...
<section className="mt-20">
  <div className="mx-auto flex max-w-6xl flex-col items-start gap-10 px-4 md:flex-row md:items-center md:px-6">
    {/* Left chart card */}
    <div className="w-full rounded-4xl bg-[#1a0d24] px-8 py-10 md:w-[55%]">
