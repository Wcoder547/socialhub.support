        ...
        <header className="border-b border-white/10 bg-[#14071b]/80 backdrop-blur">
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 md:px-8">
            ...
            <button
              ...
              className="hidden sm:inline-flex rounded-full bg-pink-500 px-4 py-2 text-xs font-semibold text-white shadow-[0_10px_30px_rgba(255,0,122,0.6)] hover:bg-pink-600"
            >
              Open Earn Coins
            </button>
          </div>
