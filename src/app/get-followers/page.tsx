...
export default function CreateTaskPage() {
  ...
  const [lastTaskInfo, setLastTaskInfo] = useState<{
    followers: number;
    reward: number;
    totalCost: number;
    remaining: number;
  ...
  const handleCreateTask = async () => {
    ...
    const cleanUsername = tiktokUsername.trim();
    console.log("[CREATE TASK FRONTEND] Payload:", {
      tiktokLink,
    ...
    try {
      ...
      console.log("[CREATE TASK FRONTEND] Response status:", res.status);
      console.log("[CREATE TASK FRONTEND] Response body:", data);
      ...
      console.error("[CREATE TASK FRONTEND] Error:", err);
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
            <div className="w-full max-w-sm rounded-2xl bg-[#1b0d24] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.8)]">
              ...
              <div className="mt-4 space-y-2 text-xs">
                ...
                {lastTaskInfo.tiktokUsername && (
                  <div className="flex justify-between">
                    <span className="text-white/60">TikTok Username</span>
                    <span className="max-w-40 truncate text-right">
                      @{lastTaskInfo.tiktokUsername}
                    </span>
                  </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-3 flex items-center rounded-full bg-[#200d28] px-4 py-3 text-xs text-white/60">
                    <input
                      ...
                      onChange={(e) =>
                        setTiktokUsername(e.target.value.replace(/\s+/g, ""))
                      }
                  ...
                  <p className="mt-2 text-[11px] text-white/40">
                    Enter only your handle (for example: @user123). This will be
                    used for search on the Earn Coins page.
                  </p>
                </div>
